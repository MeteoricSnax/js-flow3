...
var p = mongoose.connect(
  "mongodb+srv://admin:PdlR6gfB2lNtfSXS@cluster0-crynu.mongodb.net/test?retryWrites=true",
  { useNewUrlParser: true, useCreateIndex: true }
);
p.then(con => console.log("------------- Connected -------------"));

//setTimeout(() => { console.log("Disconnected"); mongoose.disconnect() }, 10000);
...
(async function runTests(){
 ...
 const dist = await findDistanceToPlayerWithGJU(12.572307586669922, 55.78275147606406, "JanInside");
 ...
 players2.forEach(p =>{ console.log(`${p.name}, Distance: ${p.distance.toFixed(2)}`)});
